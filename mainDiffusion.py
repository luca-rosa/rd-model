...
x_a = 0.1               # ahl production rate
x_g = .1                # gfp production rate
lambda_a = 2.3             # hill coeff ahl2
K_a = 40              # M and M constant for ahl2
D = 0.03            # arabinose diffusion coeff (#mm2/min)
D_a = 0.3               # ahl diffusion coeff
w = 0.75  # dx, dy  # grid cell width
rho_n = 3               # nutrients degradation rate
rc = 6 * 0.0001     #
Dc = 0.0001         # cells diffusion rate
rho = 5 * 0.001     # ahl degradation rate
lambda_n = 2.0              # hill coeff
K_n = 80
